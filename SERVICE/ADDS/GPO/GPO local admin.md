...
Cette GPO permet de gérer les droits d'administration locale de toutes les machines **depuis un seul endroit** (le DC), plutôt que machine par machine.![[Gpo_admin_localaddgroup.png]]![[Gpo_admin_localaddgroup2.png]]